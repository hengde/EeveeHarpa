...
public class CapturedBubbleEvent : GameEvent
{

}

public class IncreaseDifficultyEvent : GameEvent
{
  int difficultyAmount;
  public IncreaseDifficultyEvent(int difAmt)
  {
    difficultyAmount = difAmt;
  }
}
