...
public static class ExtensionMethods {
	...
	public static void SetYRotation(this Transform tf, float newRotation){
		tf.eulerAngles = new Vector3(tf.eulerAngles.x, newRotation, tf.eulerAngles.z);
	}

	public static void AddZRotation(this Transform tf, float addRotation){
		tf.SetZRotation(tf.transform.rotation.z + addRotation);
	}

	public static void AddYRotation(this Transform tf, float addRotation){
		Debug.Log(tf.transform.rotation.y);
		Debug.Log(addRotation);
		Debug.Log(tf.transform.rotation.y + addRotation);
		tf.SetYRotation(tf.transform.rotation.y + addRotation);
	}
